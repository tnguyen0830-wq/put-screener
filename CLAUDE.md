...
2026-09-19 — Không có việc đang làm dở. Mới nhất: #190 tab Tin tức thêm hình ảnh mỗi tin + tự dịch tiêu đề sang tiếng Việt. Còn treo từ #184: hình dạng ElevenLabs khi tổng hợp audio thật (`/api/ttsprobe` chỉ đo hai endpoint miễn phí, xem README/DEPLOY.md); tab Tin tức (#181/#190) — phần Nguồn trên màn hình và hình dạng ảnh/UW news vẫn là probe, chưa đo được từ sandbox.
