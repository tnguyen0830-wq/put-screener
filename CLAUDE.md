...
2026-09-19 — Không có việc đang làm dở. Mới nhất: giọng AI ElevenLabs cho bản tóm tắt tab Tin tức (#184) — CHƯA ĐO hình dạng ElevenLabs, chủ app đặt `ELEVENLABS_API_KEY` rồi chạy `/api/ttsprobe`; tab Tin tức (#181) — phần Nguồn trên màn hình chính là probe.
...
No PR is currently open and unmerged as of #184. If you're reading this and a
