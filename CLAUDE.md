...
2026-09-18 — Không có việc đang làm dở. Tab Đầu tư dài hạn: lưu kết quả quét (#144), ô tích trên SMA200 (#145), nút vốn hoá (#146), nút dòng tiền RRG (#147), nút "Tại sao rớt?" trả lời đúng tiếng Việt + nguồn hồ sơ SEC (#148), thêm Google News thành nguồn tin thứ ba (#149). CHƯA XÁC NHẬN, cần chủ app bấm thử ở production: (a) câu trả lời của Claude đã ra tiếng Việt chưa — sandbox không gọi được Anthropic; (b) Google News có trả RSS thật không — `news.google.com` bị proxy chặn ở đây đúng như Yahoo, nguồn đã chạy tốt từ lâu, nên hỏng thì màn hình sẽ in nguyên văn thứ Google trả về chứ không im lặng.
...
No PR is currently open and unmerged as of #149. If you're reading this and a
