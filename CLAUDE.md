...
- 2026-09-08 — #108 Dark theme reskinned to match the owner's Schwab app, from colours SAMPLED out of their screenshots (per-pixel classification, not eyeballing): paper #111518, card #161a1d, gain #4cb84c, loss #e5484d, accent #009dda, brand pill #016e99, and the distinctive blue-tinted muted #8f99a3. All pairs contrast-checked. Type scale lifted (body 14→15, .stats dd 15→18) after measuring the reference's 0.72 label:number ratio. Light theme untouched; font family deliberately kept (Be Vietnam Pro, for Vietnamese diacritics). Touches globals.css only.
