...
2026-09-06 — SPX gets past 502 now but computeGex() finds no usable contracts. Tolerant numeric parsing + a real diagnosis of why every contract was dropped. Branch: claude/gex-spx-diagnose.
