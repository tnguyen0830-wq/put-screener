...
**Since #219 the default source is every fill over UW's WebSocket**
(`liveflowws.ts`); the REST alerts below are the second button. Nothing about
the socket is measured: URL `wss://api.unusualwhales.com/socket?token=…`, the
