...
2026-09-15 — tastytrade: probe `/api/ttprobe` đã merge (#127). **CHỜ chủ app đặt biến TT_* trên Render và gửi lại JSON của probe.** Bước kế tiếp — vá hard gate earnings (đang pass cho ~450 mã ngoài watchlist vì thiếu dữ liệu) + IV rank từ tastytrade — KHÔNG được viết cho tới khi có kết quả đo thật. Không có branch đang mở.
...
No PR is currently open and unmerged as of #127. If you're reading this and a
