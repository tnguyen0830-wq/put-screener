...
2026-09-19 — Không có việc đang làm dở. Mới nhất: #189 sắp xếp lại thứ tự tab + ép nhãn tab luôn tiếng Anh. Còn treo từ #184: hình dạng ElevenLabs khi tổng hợp audio thật (`/api/ttsprobe` chỉ đo hai endpoint miễn phí, xem README/DEPLOY.md); tab Tin tức (#181) — phần Nguồn trên màn hình chính là probe.
